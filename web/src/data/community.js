...
export const COMMUNITY_MEMBERS = [
  { name:"Mira K.",     skills:["Prompt-Engineering","B2B-Vertrieb"],     open:"Co-Autor:in", avatar:"MK", color:"var(--tomato-deep)" },
  { name:"Jonas R.",    skills:["Branchenmodelle","Workshop-Design"],    open:"Reviewer",     avatar:"JR", color:"var(--leaf)" },
  { name:"Stefan W.",   skills:["AI-Act","DSGVO"],                       open:"Trust Review", avatar:"SW", color:"var(--amber)" },
  { name:"Elias T.",    skills:["Bildungs-Use-Cases","Förder-Reporting"], open:"Co-Work",      avatar:"ET", color:"var(--slate)" },
];
...
export const REWARD_BADGES = [
  ...
  { id:"trust_contrib", label:"Trust Contributor",           earned: true,  color:"var(--slate)"       },
